...
<center><h2>Terms and Conditions</h2></center>
    ...
    if(isset($_POST["agree"]))
    {
        ...
        $data = "UPDATE qacoordinator SET agreement = 'yes' WHERE id = :user_id";
    ...
    ?>
    <?php                 $_SESSION['al_msg'] = array('type' => 'Info', 'header' =>'Information', 'body'=>"You must agreed to the terms and conditions.");
    ?>
            <script>
