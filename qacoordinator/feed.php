...
?>
    ...
    <div class="write-status">
        ...
        <form class="statusplace" id="statusplace" action="../controller/qacofeedcontroller.php" method="post" enctype="multipart/form-data">
        ...
        ?>
                ...
                <div class="post-container">
                    ...
                    <?php if (!empty($row['file'])) : ?>
                        ...
                        <br>
                        <div class="buttons">
                            <form action="../controller/qacofeedcontroller.php" method="post">
