...
?>
    ...
    <div class="write-status">
        ...
        <form class="statusplace" id="statusplace" action="../controller/adminfeedcontroller.php" method="post" enctype="multipart/form-data">
...
<form action="compress.php" method="post">
 <button type="submit" class="download">Download Documents</button>
</form>
</div>
<br><br>
        <?php
        ...
        ?>
                ...
                <div class="post-container">
                    ...
                    <?php if (!empty($row['file'])) : ?>
                        ...
                        <br>
                        <div class="buttons">
                            <form action="../controller/adminfeedcontroller.php" method="post">
