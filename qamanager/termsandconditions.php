...
<center><h2>Terms and Conditions</h2></center>
    ...
    if(isset($_POST["agree"]))
    {
        ...
        $data = "UPDATE qamanager SET agreement = 'yes' WHERE id = :user_id";
        ...
        if (isset($_SESSION["uploaded_file"]) && isset($_SESSION["fileName"])) {
            ...
            if (!in_array(strtolower($fileExtension), $allowedExtensions)) {
                ...
                $_SESSION['al_msg'] = array('type' => 'Warning', 'header' =>'Invalid', 'body'=>"Please upload a document file (.docx).");
    ...
    ?>
            <script>
            <?php $_SESSION['al_msg'] = array('type' => 'Information', 'header' =>'Information', 'body'=>"You must agree to terms and conditions!");?>
