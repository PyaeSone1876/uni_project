...
<center><h2>Terms and Conditions</h2></center>
    ...
    if(isset($_POST["agree"]))
    {
        ...
        $data = "UPDATE staff SET agreement = 'yes' WHERE id = :user_id";
        ...
        if (isset($_SESSION["uploaded_file"]) && isset($_SESSION["fileName"])) {
         ...
         $sql = "INSERT INTO ideas (uid, username, content, like_count, unlike_count, comment_count, category, date_created, Post_Anno) VALUES (:uid, :username, :content, 0, 0, 0, :category, :today_date, :postAnno)";
                ...
                $_SESSION['al_msg'] = array('type' => 'Information', 'header' =>'Information', 'body'=>"Your idea was submitted!");
                echo "<script>
                location.href = '../staff/feed.php';
                </Script>";
        }
    ...
    ?>
            <?php 
                $_SESSION['al_msg'] = array('type' => 'Information', 'header' =>'Information', 'body'=>"You must agree to terms and conditions!");?>
            <script>
