...
if (isset($_POST['submit'])) {   
    ...
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, 'https://formspree.io/f/xeqykykb');
    ...
    $data = "SELECT * FROM qacoordinator WHERE id = :user_id";
    ...
    if($agreeStatus == "no")
    {
        ...
        echo "<script>
        location.href = '../qacoordinator/termsandconditions.php';
        </Script>";
    }
    else{
        ...
        if (!empty($_FILES["userfile"]["name"])) { 
            ...
            if (!in_array($file_ext, $ext)) 
            {
                ...
                $_SESSION['al_msg'] = array('type' => 'Info', 'header' =>'Invalid', 'body'=>"Please upload a document file (.docx).");
            ...
            $_SESSION['al_msg'] = array('type' => 'Warning', 'header' =>'Warning', 'body'=>"Your file is too big!");
...
if (isset($_POST['like'])) {
    ...
    if ($row && $row['like_count'] == 0 ) {
        ...
        echo "<script>location.href = '../qacoordinator/feed.php';</script>";
    } else {
...
if (isset($_POST['like_cmt'])) {
    ...
    if ($row && $row['like_count'] == 0 ) {
        ...
        echo "<script>location.href = '../qacoordinator/commentsection.php';</script>";
    } else {
...
if (isset($_POST['comment'])) {
    ...
    header('Location:../qacoordinator/commentsection.php');
    exit();
}
...
try {
    ...
    $message = "The comment is '$comments'.";
...
$_SESSION['al_msg'] = array('type' => 'Info', 'header' =>'Information', 'body'=>"Your comment was submitted!");
            ...
            echo "<script>
            location.href = '../qacoordinator/commentsection.php';
            </Script>";
