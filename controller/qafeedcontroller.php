...
if (isset($_POST['submit'])) {
    ...
    $data = "SELECT * FROM qamanager WHERE id = :user_id";
    ...
    if($agreeStatus == "no")
    {
        ...
        echo "<script>
        location.href = '../qamanager/termsandconditions.php';
        </Script>";
    }
    else{
...
if (isset($_POST['like'])) {
    ...
    if ($row && $row['like_count'] == 0 ) {
        ...
        echo "<script>location.href = '../qamanager/feed.php';</script>";
    } else {
...
if (isset($_POST['like_cmt'])) {
    ...
    if ($row && $row['like_count'] == 0 ) {
        ...
        echo "<script>location.href = '../qamanager/commentsection.php';</script>";
    } else {
...
if (isset($_POST['comment'])) {
    ...
    header('Location:../qamanager/commentsection.php');
    exit();
}
