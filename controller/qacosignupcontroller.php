...
if($password !== $confirmpassword){
    ...
    echo "<script>
    location.href = '../qacoordinator/signupForm.php';
    </script>";
     
}
  

        $insert_new_register = "INSERT INTO qacoordinator (username,email,address,password,department,agreement) VALUES ('$username', '$email','$address','$password','$department','no')";
