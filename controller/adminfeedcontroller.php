...
if (isset($_POST['submit'])) {
    ...
    $data = "SELECT * FROM admin WHERE id = :user_id";
    ...
    if($agreeStatus == "no")
    {
        ...
        echo "<script>
        location.href = '../admin/termsandconditions.php';
        </Script>";
    }
    else{
        ...
        if (!empty($_FILES["userfile"]["name"])) { 
             ...
             } else if ($file_size > 1097152) 
            {
                ...
                $_SESSION['al_msg'] = array('type' => 'Info', 'header' =>'Invalid', 'body'=>"Your file is too big.");
...
if (isset($_POST['like'])) {
    ...
    if ($row && $row['like_count'] == 0 ) {
        ...
        echo "<script>location.href = '../admin/feed.php';</script>";
    } else {
...
if (isset($_POST['like_cmt'])) {
    ...
    if ($row && $row['like_count'] == 0 ) {
        ...
        echo "<script>location.href = '../admin/commentsection.php';</script>";
    } else {
...
if (isset($_POST['comment'])) {
    ...
    header('Location:../admin/commentsection.php');
    exit();
}
...
$_SESSION['al_msg'] = array('type' => 'info', 'header' =>'Information', 'body'=>"Your comment was submitted!");
            ...
            echo "<script>
            location.href = '../admin/commentsection.php';
            </Script>";
}
