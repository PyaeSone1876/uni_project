...
if($password !== $confirmpassword){
    ...
    echo "<script>
    location.href = '../qamanager/signupForm.php';
    </script>";
     
}
  

        $insert_new_register = "INSERT INTO qamanager (username,email,address,password,department,agreement) VALUES ('$username', '$email','$address','$password','$department','no')";
